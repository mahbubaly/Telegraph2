        ...
        <>
            ...
            <Container>
                ...
                <header className='flex justify-between  lg:mt-[44px] items-center'>
                    ...
                    <button className='text-[14px] lg:mr-[175px] 2xl:mr-[420px]   font-bold  w-[94px] h-[46px] bg-[#FF0043] rounded-[23px] text-[#fff] '>Try Beta</button>
                ...
                <section>
                    <div className='grid grid-cols-1 lg:grid-cols-2 justify-center gap-[46px] mt-[76px]  items-center'>
                        ...
                        <div className=''>
                            <img src={img} className=' lg:w-[654.712px] h-[604px] pr-[76.37px]' alt="" />
